...
var domains = (function() {
    ...
    domains.prototype.recordGet = function(parameters) {
        ...
        if (parameters['type'] === undefined || parameters['name'] === undefined) {
            path = path.replace('{type}/{name}', '');
        } else {
     ...
     *
     */
    domains.prototype.recordDel = function(parameters) {
        if (parameters === undefined) {
            parameters = {};
        }
        var deferred = Q.defer();
